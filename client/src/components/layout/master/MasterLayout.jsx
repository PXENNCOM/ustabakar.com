...
export default function MasterLayout() {
  return (
    <div className="min-h-screen antialiased flex flex-col bg-white text-stone-900 relative">
      ...
      {/* HEADER: En dış sınır çizgisi ve padding alt tarafla eşit */}
      <div className="w-full max-w-7xl mx-auto px-6 md:px-12">
        <Header />
      </div>

      {/* ANA İÇERİK: Header ile tamamen aynı genişlik ve hizalama */}
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-12 h-12 bg-[#25D366] hover:bg-[#1ebe5d] active:scale-90 rounded-2xl shadow-xl shadow-emerald-500/20 transition-all duration-300 group relative" title="WhatsApp Destek">
